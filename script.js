class Game {
  ...
  * Display score
   ...
   */
  showGrade(score) {
    if (score > 30) return "mamamu pasti bangga!!!";else
    if (score > 25) return "lanjutkan bakatmu nak";else
    if (score > 20) return "wow keren";else
    if (score > 15) return "bagus!";else
    if (score > 13) return "ada peningkatan!";else
    if (score > 10) return "lumayanlah!";else
    if (score > 5) return "pemula ya?";else
    return "Serius njirr segini?";
  }
